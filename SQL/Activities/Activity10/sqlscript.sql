...
Select order_no from orders where salesman_id='5001';

Select order_no from orders where salesman_id(select salesman_id from Customers where customer_id='3007);
...
Select order_no from orders where salesman_id = (select salesman_id from orders where customer_id='3007);
...
select order_no from orders a inner join customer b on a.salesman_id=b.salesman_id where city='New york';

select order_no from orders a inner join customers b on a.salesman_id=b.salesman_id where city='New york';

select order_no from orders where salesman_id=(select salesman_id from customers where city='new york');

select order_no from orders where salesman_id=(select salesman_id from salesman where city='new york');

select order_no from orders where salesman_id=(select salesman_id from salesman where salesman_city='new york');
...
select salesman_id from customers where salesman_city='new york';

select salesman_id from customers where city='new york';
...
select order_no from orders where salesman_id=(select distinct salesman_id from customers where city='New York');

select order_no from orders a inner join customers b on a.salesman_id=b.salesman_id where city='New York';

select count(customers) from customers where grade>avg(select grade from customers where city='New York');

select grade from customers where city='New York';

select count(customer_id) from customers;

select count(customer_id) from customers where grade>150;

select count(customers) from customers where grade>(avg(select grade from customers where city='New York'));

select grade from customers where city='New York';

select count(customers) from customers group by grade having grade>(avg(select grade from customers where city='New York'));

'));


select count(*) from customers group by grade having grade>(avg(select grade from customers where city='New York'));
...
select salesman_id,grade from salesman;

select grade, count(customers) from customers group by grade having grade>(select avg(grade) from customers where city='New York');
...
SELECT salesman_id from salesman having max(commission);

SELECT salesman_id from salesman where commission= max(commission);

SELECT max(commission),salesman_id from salesman;
...
select salesman_id from salesman where max(commission);
